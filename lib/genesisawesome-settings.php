...
class GenesisAwesome_Childtheme_Settings extends Genesis_Admin_Boxes {
	...
	function __construct() {
		...
		$menu_ops = array(
			'submenu' => array(
				'parent_slug' => 'genesis',
				'page_title'  => __( 'GenesisAwesome - Dedicated Theme Settings', 'genesisawesome' ),
				'menu_title'  => __( 'Dedicated Settings', 'genesisawesome' )
			)
		);
		...
		$default_settings = array(
			...
			'enable_post_related_subscribe' => 1,
			'feedburner_id'                 => '',
			'contact_email'                 => '',
			'recaptcha_publickey'           => '',
	...
	function general_settings() {
		...
		<table class="form-table">
			...
			<tr valign="top">
				<th scope="row"><label for="<?php echo $this->get_field_id( 'enable_post_related_subscribe' ); ?>"><?php _e( 'Enable Related posts and Subscribe box ?', 'genesisawesome' ); ?></label></th>
				<td><input type="checkbox" name="<?php echo $this->get_field_name( 'enable_post_related_subscribe' ); ?>" id="<?php echo $this->get_field_id( 'enable_post_related_subscribe' ); ?>" value="1"<?php checked( '1', $this->get_field_value( 'enable_post_related_subscribe' ) ); ?> /></td>
			</tr>
			<tr valign="top">
	...
	function social_settings() {
		...
		<table class="form-table">
			...
			<tr valign="top">
				<th scope="row"><label for="<?php echo $this->get_field_id( 'delicious_url' ); ?>"><?php _e( 'Delicious URL', 'genesisawesome' ) ?></label></th>
				<td><input type="text" name="<?php echo $this->get_field_name( 'delicious_url' ); ?>" id="<?php echo $this->get_field_id( 'delicious_url' ); ?>" value="<?php echo esc_attr( $this->get_field_value( 'delicious_url' ) ); ?>" class="widefat" /></td>
			</tr>
			<tr valign="top">
				<th scope="row"><label for="<?php echo $this->get_field_id( 'youtube_url' ); ?>"><?php _e( 'Youtube URL', 'genesisawesome' ) ?></label></th>
			...
			<tr valign="top">
				<th scope="row"><label for="<?php echo $this->get_field_id( 'digg_url' ); ?>"><?php _e( 'Digg URL', 'genesisawesome' ) ?></label></th>
				<td><input type="text" name="<?php echo $this->get_field_name( 'digg_url' ); ?>" id="<?php echo $this->get_field_id( 'digg_url' ); ?>" value="<?php echo esc_attr( $this->get_field_value( 'digg_url' ) ); ?>" class="widefat" /></td>
			</tr>
		</table>
		<p class="description">
